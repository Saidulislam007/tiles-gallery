    ...
    >
      <div className="flex items-center justify-between px-6 md:px-14 py-4 md:py-6">
        ...
        <div className="hidden md:flex space-x-6 items-center">
          <Link href="/" className="hover:text-blue-400 text-xl">
            Home
          </Link>

          <Link href="/allTiles" className="hover:text-blue-400 text-xl">
            All Tiles
          </Link>

          <Link href="/profile" className="hover:text-blue-400 text-xl">
            My Profile
          </Link>
        </div>
